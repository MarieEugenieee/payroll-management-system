...
# Manage Employee
urlpatterns += [
    path('add-employee/',  manage_employee.AddEmployeeView.as_view(), name='add_employee'),
    ...
    path('add_employee_info/<int:pk>/', manage_employee.EditEmployeeView.as_view(), name='add_employee_info'),
    ...
    path('delete_employee/<int:pk>/', manage_employee.DeleteEmployeeView.as_view(), name='soft_delete_employee'),
