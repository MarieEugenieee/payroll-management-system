...
# filters
from reception.filters import AttendanceFilters
...
# forms
from reception.forms import AttendanceForm


class AddAttendanceView(LoginRequiredMixin, AdminPassesTestMixin, CreateView):
    model = Attendance
    form_class = AttendanceForm
    template_name = 'authority/add_attendance.html'
    success_url = reverse_lazy('authority:add_attendance')
...
class UpdateAttendaceView(LoginRequiredMixin, AdminPassesTestMixin, UpdateView):
    model = Attendance
    form_class = AttendanceForm
    template_name = 'authority/attendance_list.html'
    success_url = reverse_lazy('authority:attendance_list')
...
class AttendanceListView(LoginRequiredMixin, AdminPassesTestMixin, ListView):
    model = Attendance
...
class DeleteAttendanceView(LoginRequiredMixin,AdminPassesTestMixin, DeleteView):
    model= Attendance
